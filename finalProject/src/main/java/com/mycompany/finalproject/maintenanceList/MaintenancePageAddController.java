...
public class MaintenancePageAddController implements Initializable, PropertyReceiver, ContractorReceiver{
    ...
    public void add(ActionEvent event) {
        ...
        Maintenance maintenance = new Maintenance(maintenanceType, startDate, endDate, totalCost, details, propertyId, propertyAddress, contractorId, contractorCompanyName);
        try {
            DatabaseServices.addModelToDb(maintenance);
        } catch (SQLException ex) {
            Utility.setLabelMessageAndColor(message, "Error: New Maintenance information could not be added to the dababse.", "Red");
            return;
        }
        maintenanceTable.getItems().add(maintenance);
        Utility.setLabelMessageAndColor(result, "Maintenance successfully created.", "Green");
        close(event);
    }
    ...
    /**
     * 
     * @param maintenanceTable 
     */
    public void setTableView(TableView<Maintenance> maintenanceTable) {
